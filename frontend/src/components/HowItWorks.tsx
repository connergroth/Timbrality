...
export function HowItWorks() {
  ...
  return <section id="how-it-works" className="py-20 px-6 bg-gray-800/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => <div key={index} className="text-center p-6 rounded-xl bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300">
